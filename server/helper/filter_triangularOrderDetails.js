            ...
            case 'Kraken':
                try {
                    ...
                    if (orderDetails.status == 'closed') {
                        ...
                        // orderDetails.orderFilledTotal = orderDetails.orderAmount * orderDetails.price;
                        orderDetails.orderAmount = Number(orderDetails.vol_exec) - Number(orderDetails.fee);
                        orderDetails.orderFilledTotal = Number(orderDetails.cost) - Number(orderDetails.fee);
                    }
                    else if (orderDetails.status == 'canceled') {
                        orderDetails.orderStatus = 'cancelled';
                    }
