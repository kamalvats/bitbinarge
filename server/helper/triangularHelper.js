        ...
        switch (token) {
            ...
            default:
                if (tickers[token + 'USDT']) {
                    ...
                    return quantity * tickers[token + 'USDC']['price'];
                }
                break;
        }
    }
...
module.exports = {
    ...
    execute_paths: async (paths, exchange, tickers, capital, quantity) => {
        ...
        for (let [id, data] of Object.entries(paths)) {
            ...
            orders.which_pair = data.coins[0];
            if(data.coins[0]!='USDT' && data.coins[0]!="USDC"){
                orders.which_pair = start;
            }
            ...
            if (orders.pair === "USDT" || test[test.length - 1].quoteCurrency === "USDT") {
                orders.which_pair = "USDT";
            }
