...
export default Express.Router()
    ...
    .get('/getPairs', controller.getPairs)
    .get('/checkPairs', controller.checkPairs)
    .get('/profitStatistic', controller.profitStatistic)
    ...
    .put('/updatePairs', controller.updatePairs)
    .get('/exchangeTradeCount', controller.exchangeTradeCount)
    .get('/transactionStatistic', controller.transactionStatistic)
