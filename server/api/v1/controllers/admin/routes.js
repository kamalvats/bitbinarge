...
export default Express.Router()
    ...
    .post("/deactivateSubscription",controller.deactivateSubscription)
    ...
    .put("/updateWalletUser",controller.updateWalletUser)
    .get("/poolPlanTransactions",controller.poolPlanTransactions)
