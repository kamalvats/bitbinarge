...
export class userController {
  ...
  async script(req, res, next) {
    try {
      ...
      await multiUpdateUser({},{$set:{aedGardoAddress:"",totalReward:0,mainWalletBalance:0,rewardWalletBalance:0,previousPlaneId:"",previousPlanName:"",previousPlanStatus:"",subscriptionPlaneId:null,currentPlanName:"",currentPlanStatus:"",planCapitalAmount:0,paymentType:"",subscriptionType:""}})
 ...
 */
 ...
 let getWalletBalance = await aedGardoPaymentFunctions.getWalletBalance(adminResult._id, config.get("aedgardoApiKey"));
      ...
      if(validatedBody.transferType == "CLIENT"){
...
await updateUser({_id:adminResult._id},{$inc :{fuelUSDBalance: Number(validatedBody.amount)}})
      let order_id = commonFunction.generateOrder();
      await createTransaction({
        userId: adminResult._id,
        amount: validatedBody.amount,
        ...
        status: status.COMPLETED,
        walletType: req.body.walletType,
        transferTo:adminResult._id,
        internalTransferTo: "Fuel Wallet"
      });
 ...
 let addition = await aedGardoPaymentFunctions.deduction(adminResult._id, validatedBody.amount, config.get("aedgardoApiKey"), "fund", "credit");
      ...
      await createTransaction({
        ...
        walletType: req.body.walletType,
        transferTo:adminResult._id,
        internalTransferTo: "Main Wallet"
      });
      }
