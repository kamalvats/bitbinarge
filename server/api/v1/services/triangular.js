...
const triangularServices = {
    ...
    triangularArbitrageListWithPaginate1: async (validatedBody) => {
    ...
    triangularArbitrageCount: async (query) => {
        return await triangularModel.countDocuments(query);
    },
    triangularDelete: async (query) => {
        return await triangularModel.deleteOne(query);
    },
}
