...
const intraAbitrageSingleExchangeServices = {
    ...
    intraArbitrageSingleExchangeArbitrageListWithPaginate1: async (validatedBody) => {
    ...
    intraArbitrageSingleExchangeCount: async (query) => {
        return await intraArbitrageSingleExchangeModel.countDocuments(query);
    },
    intraAbitrageSingleExchangeDelete: async (query) => {
        return await intraArbitrageSingleExchangeModel.deleteOne(query);
    },
}
