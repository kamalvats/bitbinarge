module.exports = {
	...
	BUY_PLAN: 'Subscription assigned successfully.',
	...
	COUPON_ALREADY_EXITS: "Coupon name already exist!.",
	PLAN_PRICE_LOW: "Coupon discount connot be more than plan price",
	...
	PAYMENT_PROCEED: "QR code generated. Please proceed with payment to activate the plan.",
	KEYS_NOT_FOUND: "Trustpayment keys not found.",
	KEYS_UPDATED: "Trustpayment keys updated successfully.",
	DOCUSEAL_NOT_FOUND: "Docuseal not found",
	DOCUSEAL_REJECTED: "Docuseal rejected successfully",
	NEW_LETTER: "You have subscribe successfully.",
	INVALID_COUPON_FOR_THIS_PLAN: "The coupon is invalid for this plan. Please contact the administrator for assistance.",
	ALREADY_UPDATED: (type) => `Your payment method already updated to ${type}.`,
	REFUND_SUCCESS: (amount) => `The refund of ${amount} has been successfully processed.`,
